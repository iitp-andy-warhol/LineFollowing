    ...
    if contours_blk_len > 0:
        ...
        if ccw:
            ...
            if address == 0 and ang > 70:
                ...
                address = 6
                start = False
            elif address == 6 and ang < -35:
                print("address: 202")
                address = 5
            elif address == 5 and ang > 65:
                print("address: 203")
                address = 4
            elif address == 4 and ang < 18:
                address = 43
            elif address == 43 and ang > 62:
                print("address: 103")
                address = 3
            elif address == 3 and ang < 0:
                print("address: 102")
                address = 2
            elif address == 2 and ang > 62:
                print("address: 101")
                address = 1
...
results = {'time01': time01, 'time12': time12, 'time23': time23, 'time34': time34, 'time45': time45, 'time56': time56, 'time60': time60}

f = open("path_ccw_stop.pkl", "wb")
